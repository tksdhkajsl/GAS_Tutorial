...
void EmptyLinkFunctionForGeneratedCodeKI07_Unreal_GAS_init() {}
	static FPackageRegistrationInfo Z_Registration_Info_UPackage__Script_KI07_Unreal_GAS;
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_KI07_Unreal_GAS()
	{
		if (!Z_Registration_Info_UPackage__Script_KI07_Unreal_GAS.OuterSingleton)
		{
			static const UECodeGen_Private::FPackageParams PackageParams = {
				"/Script/KI07_Unreal_GAS",
				nullptr,
				0,
